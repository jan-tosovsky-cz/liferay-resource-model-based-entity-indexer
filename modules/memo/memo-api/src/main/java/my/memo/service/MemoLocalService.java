...
/**
 * Provides the local service interface for Memo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MemoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MemoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>my.memo.service.impl.MemoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the memo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MemoLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Memo addMemo(long userId, long groupId, String text, String summary)
